...
body {
background-image: linear-gradient(rgba(255, 255, 255, 0.7) 30%, rgba(255, 255, 255, 0) 70%), url(http://assets.cliftonpark.wa.edu.au.s3.ap-southeast-1.amazonaws.com/background-images/wood-work.jpg);
